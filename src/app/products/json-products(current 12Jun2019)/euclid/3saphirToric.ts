this.products = [
  {
    "code": "", "name": "Euclid",
    "codeSpectrum": "",
    "priceBase": 140, "price1": 140, "price2": 130, "price3": 130,
    "father": "Sapphire Toric", // se necesita asi para una condicion de style
    ...
    "types": [
      {
        ...
        "parameters": [
          ...
          { "name": "Sphere (D)", "type": "selected", "values": ["-8.00","-7.75","-7.50","-7.25","-7.00","-6.75","-6.50","-6.25","-6.00","-5.75","-5.50","-5.25","-5.00","-4.75","-4.50","-4.25","-4.00",
                                                                 "-3.75","-3.50","-3.25","-3.00","-2.75","-2.50","-2.25","-2.00","-1.75","-1.50","-1.25","-1.00","-0.75","-0.50","-0.25","0.00"],"selected": null },
          { "name": "Cylinder (D)", "type": "selected", "values": ["-3.00","-2.75","-2.50","-2.25","-2.00","-1.75"], "selected": null },
