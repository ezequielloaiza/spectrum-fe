  ...
  buildProductsSelected() {
    ...
    _.each(productsSelected, function(productSelected, index) {
      ...
      if (productSelected.eye === "Right") {
        ...
        productSelected.price = product.priceSale * productSelected.quantity;
        ...
        if (warrantyRight) {
          productSelected.price = productSelected.price + (product.additional * productSelected.quantity);
        }
