this.products = [
  {
    "code": "S4S", "name": "Quattro Sph (14.50) 3-Monthly Single",
    ...
    "types": [
      {
        "name": "Spheric",
        "parameters": [
          { "name": "Diameter (mm)", "type": "selected", "values": ["13.00", "14.50"], "selected": null },
          { "name": "Base Curve (mm)", "type": "selected", "values": ["7.10", "7.40", "7.70", "8.00", "8.30", "8.60", "8.90", "9.20", "9.50", "9.80"], "selected": null },
