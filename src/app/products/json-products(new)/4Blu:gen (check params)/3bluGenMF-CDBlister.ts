this.products = [
  {
    "code": "BMD", "name": "Blu:gen MF CD Blister",
    "priceBase": 1000, "price1": 500, "price2": 600, "price3": 700,
    "father": "Blu:gen",
    "category": "Contact Lenses",
    "subCategory": "MarkEnnovy Contact Lenses",
    "material": "Silicone Hydrogel, 75%",
    "descriptionShort": "My description short by Blu:gen",
    "description": "Blu:gen is a monthly silicone hydrogel soft contact lens that combines a selective blue light blocking filter with a 1st Class UV Filter. It features a high water content, low dehydration material, a low modulus (0.25 MPa), and our broadest range of parameters.",
    "replacementPeriod": "Monthly",
    "warranty": "",
    "url": "http://spctinternational.com/wp-content/uploads/2017/11/BLUE-GEN.pdf",
    "stock": 10,
    "types": [
      {
        "name": "Multifocal",
