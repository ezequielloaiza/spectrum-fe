    ...
    "types": [
      {
        ...
        "parameters": [
          ...
          { "name": "Base Curve", "type": "number", "values": ["6.80", "7.10", "7.40", "7.70", "8.00", "8.30", "8.60", "8.90", "9.20", "9.50", "9.80"], "selectedLeft": null, "selectedRight": true },
          { "name": "Axis Toric", "type": "number", "values": [["(Pasos de 1°) Todos"]] },
