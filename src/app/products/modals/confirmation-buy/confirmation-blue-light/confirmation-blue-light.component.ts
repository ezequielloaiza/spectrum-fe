...
@Component({
  ...
  templateUrl: './confirmation-blue-light.component.html',
  styleUrls: ['./confirmation-blue-light.component.scss']
})
export class ConfirmationBlueLightComponent implements OnInit {
