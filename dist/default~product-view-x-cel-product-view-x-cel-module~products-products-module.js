...
var ProductViewXCelComponent = /** @class */ (function () {
    ...
    ProductViewXCelComponent.prototype.missingParamsRequired = function () {
        ...
        var self = this;
        return !this.product.client || !this.product.patient || nothingSelected || lodash__WEBPACK_IMPORTED_MODULE_5__["some"](eyes, function (eye, index) {
