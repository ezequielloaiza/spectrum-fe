...
(function (RoleAdmin) {
    ...
    RoleAdmin[RoleAdmin["ProductsView"] = 11] = "ProductsView";
    RoleAdmin[RoleAdmin["ProductsViewEuropa"] = 12] = "ProductsViewEuropa";
    RoleAdmin[RoleAdmin["ProductsViewEuclid"] = 13] = "ProductsViewEuclid";
    RoleAdmin[RoleAdmin["ProductsViewMagic"] = 14] = "ProductsViewMagic";
    RoleAdmin[RoleAdmin["ProductsViewBlue"] = 15] = "ProductsViewBlue";
    RoleAdmin[RoleAdmin["Home"] = 16] = "Home";
    RoleAdmin[RoleAdmin["OrdersBySellerList"] = 17] = "OrdersBySellerList";
    RoleAdmin[RoleAdmin["OrdersDetailSeller"] = 18] = "OrdersDetailSeller";
    RoleAdmin[RoleAdmin["ViewUser"] = 19] = "ViewUser";
    RoleAdmin[RoleAdmin["EditUser"] = 20] = "EditUser";
    RoleAdmin[RoleAdmin["EditCompany"] = 21] = "EditCompany";
    RoleAdmin[RoleAdmin["ViewSeller"] = 22] = "ViewSeller";
    RoleAdmin[RoleAdmin["EditSeller"] = 23] = "EditSeller";
    RoleAdmin[RoleAdmin["ViewClient"] = 24] = "ViewClient";
    RoleAdmin[RoleAdmin["ListBasket"] = 25] = "ListBasket";
    RoleAdmin[RoleAdmin["ListBasketDetail"] = 26] = "ListBasketDetail";
})(RoleAdmin || (RoleAdmin = {}));
...
(function (RoleSeller) {
    ...
    RoleSeller[RoleSeller["ProductsView"] = 7] = "ProductsView";
    RoleSeller[RoleSeller["ProductsViewEuropa"] = 8] = "ProductsViewEuropa";
    RoleSeller[RoleSeller["ProductsViewEuclid"] = 9] = "ProductsViewEuclid";
    RoleSeller[RoleSeller["ProductsViewMagic"] = 10] = "ProductsViewMagic";
    RoleSeller[RoleSeller["ProductsViewBlue"] = 11] = "ProductsViewBlue";
    RoleSeller[RoleSeller["Home"] = 12] = "Home";
    RoleSeller[RoleSeller["OrdersBySellerList"] = 13] = "OrdersBySellerList";
    RoleSeller[RoleSeller["OrdersDetailSeller"] = 14] = "OrdersDetailSeller";
    RoleSeller[RoleSeller["ListBasket"] = 15] = "ListBasket";
    RoleSeller[RoleSeller["ListBasketDetail"] = 16] = "ListBasketDetail";
...
(function (RoleUser) {
    ...
    RoleUser[RoleUser["ProductsView"] = 7] = "ProductsView";
    RoleUser[RoleUser["ProductsViewEuropa"] = 8] = "ProductsViewEuropa";
    RoleUser[RoleUser["ProductsViewEuclid"] = 9] = "ProductsViewEuclid";
    RoleUser[RoleUser["ProductsViewMagic"] = 10] = "ProductsViewMagic";
    RoleUser[RoleUser["ProductsViewBlue"] = 11] = "ProductsViewBlue";
    RoleUser[RoleUser["ShippingAddress"] = 12] = "ShippingAddress";
    RoleUser[RoleUser["Home"] = 13] = "Home";
    RoleUser[RoleUser["ListBasketClient"] = 14] = "ListBasketClient";
})(RoleUser || (RoleUser = {}));
...
var BreadcrumbComponent = /** @class */ (function () {
    ...
    BreadcrumbComponent.prototype.ngOnInit = function () {
        ...
        if (state.snapshot.url === '/user') {
            this.breadcrumbList.push(new _models_breadcrumb__WEBPACK_IMPORTED_MODULE_1__["Breadcrumb"]('List of Clients', 'fa fa-users', './'));
        }
        else if (state.snapshot.url.substring(0, 5) === '/user') {
            this.breadcrumbList.push(new _models_breadcrumb__WEBPACK_IMPORTED_MODULE_1__["Breadcrumb"]('List of Clients', 'fa fa-users', './'));
            this.breadcrumbService.push(new _models_breadcrumb__WEBPACK_IMPORTED_MODULE_1__["Breadcrumb"]('Client', 'fa fa-user', state.snapshot.url));
        }
...
var GoogleService = /** @class */ (function () {
    ...
    GoogleService.prototype.searchCities$ = function (input) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + 'google/searchCities/' + input).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return response['predictions']; }));
    };
    GoogleService.prototype.placeById$ = function (placeId) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + 'google/placeById/' + placeId);
    };
...
/*!******************************************!*\
  !*** ./src/app/shared/services/index.ts ***!
  \******************************************/
/*! exports provided: UserService, BusinessTypeService, GoogleService, CompanyService, AuthorizationService, OrderService, WarrantyService, ProductsRequestedService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.findOrdersClientBySeller$ = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + 'order/findOrdersClientBySeller');
    };
...
var ProductsRequestedService = /** @class */ (function () {
    ...
    ProductsRequestedService.prototype.AllProductsRequestedByOrder$ = function (orderId) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + 'productsRequested/allProductsRequestedByOrder/' + orderId);
    };
