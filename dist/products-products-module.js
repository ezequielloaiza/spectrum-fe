...
var ProductViewEuclidComponent = /** @class */ (function () {
    ...
    ProductViewEuclidComponent.prototype.setClient = function () {
        ...
        if (this.user.role.idRole === 3) {
            ...
            var accSpct = !!this.currentUser.accSpct ? this.currentUser.accSpct + ' - ' : '';
            var certificationCode = !!this.currentUser.certificationCode ? ' | ' + this.currentUser.certificationCode : '';
...
var ProductViewEuropaComponent = /** @class */ (function () {
    ...
    ProductViewEuropaComponent.prototype.validateSelectedNotch = function (parameter) {
...
var ProductViewComponent = /** @class */ (function () {
    ...
    ProductViewComponent.prototype.setClient = function () {
        ...
        if (this.user.role.idRole === 3) {
            this.client = this.currentUser.idUser;
            var accSpct = !!this.currentUser.accSpct ? this.currentUser.accSpct + ' - ' : '';
            var cardCode = !!this.currentUser.cardCode ? ' | ' + this.currentUser.cardCode : '';
