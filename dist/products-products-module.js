...
var ProductViewEuropaComponent = /** @class */ (function () {
    ...
    ProductViewEuropaComponent.prototype.definePriceTickness = function (membership) {
        switch (membership) {
            case 1:
...
var ProductsListInternalComponent = /** @class */ (function () {
    ...
    ProductsListInternalComponent.prototype.open = function (product, action) {
        ...
        if (product.supplier.idSupplier !== 5 && product.supplier.idSupplier !== 4) {
            ...
            var modalRef = this.modalService.open(_modals_edit_product_edit_product_euclid_edit_product_euclid_component__WEBPACK_IMPORTED_MODULE_10__["EditProductEuclidComponent"], {
                size: 'lg',
                windowClass: 'modal-content-border'
            });
            modalRef.componentInstance.product = product;
