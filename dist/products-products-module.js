...
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ngx-spinner */ "./node_modules/ngx-spinner/ngx-spinner.umd.js");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(ngx_spinner__WEBPACK_IMPORTED_MODULE_14__);
...
/* harmony import */ var _http_user_storage_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../http/user-storage.service */ "./src/app/http/user-storage.service.ts");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ngx-spinner */ "./node_modules/ngx-spinner/ngx-spinner.umd.js");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(ngx_spinner__WEBPACK_IMPORTED_MODULE_13__);
...
var ProductViewBlueComponent = /** @class */ (function () {
    ...
    ProductViewBlueComponent.prototype.getProducts = function () {
        var _this = this;
        this.spinner.show();
        this.productService.findBySupplier$(6).subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_4__["CodeHttp"].ok) {
...
var ProductViewEuclidComponent = /** @class */ (function () {
    ...
    ProductViewEuclidComponent.prototype.getProducts = function () {
        var _this = this;
        this.spinner.show();
        this.productService.findBySupplier$(4).subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_4__["CodeHttp"].ok) {
                _this.products = res.data;
                _this.getProductView();
                _this.spinner.hide();
...
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ngx-spinner */ "./node_modules/ngx-spinner/ngx-spinner.umd.js");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(ngx_spinner__WEBPACK_IMPORTED_MODULE_20__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductViewEuropaComponent = /** @class */ (function () {
    ...
    ProductViewEuropaComponent.prototype.getProducts = function () {
        var _this = this;
        this.spinner.show();
        this.productService.findBySupplier$(2).subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_4__["CodeHttp"].ok) {
                _this.products = res.data;
                _this.getProductView();
                _this.spinner.hide();
...
var ProductViewFluoStripsComponent = /** @class */ (function () {
    ...
    ProductViewFluoStripsComponent.prototype.getProducts = function () {
        var _this = this;
        this.spinner.show();
        this.productService.findBySupplier$(7).subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_4__["CodeHttp"].ok) {
                _this.products = res.data;
                _this.getProductView();
                _this.spinner.hide();
...
/* harmony import */ var _shared_services_basket_basket_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../shared/services/basket/basket.service */ "./src/app/shared/services/basket/basket.service.ts");
/* harmony import */ var _shared_services_shippingAddress_shipping_address_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/services/shippingAddress/shipping-address.service */ "./src/app/shared/services/shippingAddress/shipping-address.service.ts");
...
/* harmony import */ var _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../shared/enum/code-http.enum */ "./src/app/shared/enum/code-http.enum.ts");
...
/* harmony import */ var _shared_models_productrequested__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../shared/models/productrequested */ "./src/app/shared/models/productrequested.ts");
/* harmony import */ var _shared_models_product__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../shared/models/product */ "./src/app/shared/models/product.ts");
/* harmony import */ var _modals_confirmation_buy_confirmation_lenticon_confirmation_lenticon_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../modals/confirmation-buy/confirmation-lenticon/confirmation-lenticon.component */ "./src/app/products/modals/confirmation-buy/confirmation-lenticon/confirmation-lenticon.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductViewLenticonComponent = /** @class */ (function () {
    ...
    ProductViewLenticonComponent.prototype.getProducts = function () {
        var _this = this;
        this.spinner.show();
        this.productService.findBySupplier$(3).subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_12__["CodeHttp"].ok) {
                _this.products = res.data;
                _this.getProductView();
                _this.spinner.hide();
            }
    ...
    ProductViewLenticonComponent.prototype.getProductView = function () {
        console.log(JSON.stringify(lodash__WEBPACK_IMPORTED_MODULE_13__["range"](4, 10, 0.5)));
        this.id = +this.route.snapshot.paramMap.get('id');
        this.product = lodash__WEBPACK_IMPORTED_MODULE_13__["find"](this.products, { idProduct: this.id });
        this.product.eyeRight = false;
        this.product.eyeLeft = false;
        this.product.parametersRight = JSON.parse(this.product.types)[0].parameters;
        this.product.parametersLeft = JSON.parse(this.product.types)[0].parameters;
    ...
    ProductViewLenticonComponent.prototype.findShippingAddress = function (idCliente) {
        ...
        this.shippingAddressService.findIdUser$(idCliente).subscribe(function (res) {
            ...
            else if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_12__["CodeHttp"].notContent) {
                _this.product.shippingAddress = '';
                _this.translate.get('You must enter a main address in the shipping address module', { value: 'You must enter a main address in the shipping address module' }).subscribe(function (res) {
                    _this.notification.warning('', res);
                });
    ...
    ProductViewLenticonComponent.prototype.buildProductsSelected = function () {
        ...
        lodash__WEBPACK_IMPORTED_MODULE_13__["each"](productsSelected, function (productSelected, index) {
            productSelected.id = product.idProduct;
            productSelected.patient = product.patient;
            productSelected.price = product.priceSale;
            if (productSelected.eye === "Right") {
                ...
                productSelected.observations = product.observationsRight;
                /* set*/
                lodash__WEBPACK_IMPORTED_MODULE_13__["each"](product.setRight, function (parameter, index) {
                    if (parameter.name === 'num.LC') {
                        var value = parameter.selected.value;
                        parameter.selected = value;
                    }
                    product.setRight[index] = lodash__WEBPACK_IMPORTED_MODULE_13__["omit"](parameter, ['type', 'values', 'sel']);
                });
                productSelected.set = product.setRight;
                /*params*/
                lodash__WEBPACK_IMPORTED_MODULE_13__["each"](product.parametersRight, function (parameter, index) {
                    if (parameter.name === 'Addition' || parameter.name === 'Center') {
                        if (parameter.selected === null || parameter.selected === undefined) {
                            parameter.selected = '';
                        }
                    }
                    product.parametersRight[index] = lodash__WEBPACK_IMPORTED_MODULE_13__["omit"](parameter, ['type', 'values', 'sel', 'placeholder']);
                });
                productSelected.parameters = product.parametersRight;
            ...
            if (productSelected.eye === "Left") {
                ...
                productSelected.observations = product.observationsLeft;
                /* set*/
                lodash__WEBPACK_IMPORTED_MODULE_13__["each"](product.setLeft, function (parameter, index) {
                    if (parameter.name === 'num.LC') {
                        var value = parameter.selected.value;
                        parameter.selected = value;
                    }
                    product.setLeft[index] = lodash__WEBPACK_IMPORTED_MODULE_13__["omit"](parameter, ['type', 'values', 'sel']);
                });
                productSelected.set = product.setLeft;
                /*params*/
                lodash__WEBPACK_IMPORTED_MODULE_13__["each"](product.parametersLeft, function (parameter, index) {
                    if (parameter.name === 'Addition' || parameter.name === 'Center') {
                        if (parameter.selected === null || parameter.selected === undefined) {
                            parameter.selected = '';
                        }
                    }
                    product.parametersLeft[index] = lodash__WEBPACK_IMPORTED_MODULE_13__["omit"](parameter, ['type', 'values', 'sel', 'placeholder']);
                });
                productSelected.parameters = product.parametersLeft;
            ...
            productsSelected[index] = lodash__WEBPACK_IMPORTED_MODULE_13__["omit"](productSelected, ['parameters', 'eye', 'set']);
        });
        return productsSelected;
    };
    ProductViewLenticonComponent.prototype.addToCart = function (type) {
        ...
        var productsRequested = [];
        var productsSelected = this.buildProductsSelected();
        lodash__WEBPACK_IMPORTED_MODULE_13__["each"](productsSelected, function (product) {
            var productRequest = new _shared_models_productrequested__WEBPACK_IMPORTED_MODULE_15__["ProductRequested"]();
            var productoSelect = new _shared_models_product__WEBPACK_IMPORTED_MODULE_16__["Product"]();
            productoSelect.idProduct = product.id;
            productRequest.product = productoSelect;
            productRequest.quantity = product.quantity;
            productRequest.price = product.price;
    ...
    ProductViewLenticonComponent.prototype.openModal = function (type) {
        var _this = this;
        var modalRef = this.modalService.open(_modals_confirmation_buy_confirmation_lenticon_confirmation_lenticon_component__WEBPACK_IMPORTED_MODULE_17__["ConfirmationLenticonComponent"], { size: 'lg', windowClass: 'modal-content-border' });
        modalRef.componentInstance.datos = this.basketRequestModal;
        modalRef.componentInstance.product = this.product;
        modalRef.componentInstance.typeBuy = type;
        modalRef.componentInstance.role = this.user.role.idRole;
    ...
    ProductViewLenticonComponent.prototype.formIsValid = function () {
        ...
        if (this.product.eyeRight) {
            var addAux_1 = false;
            lodash__WEBPACK_IMPORTED_MODULE_13__["each"](this.product.parametersRight, function (param) {
            ...
            lodash__WEBPACK_IMPORTED_MODULE_13__["each"](this.product.setRight, function (param) {
                if (param.selected === null || param.selected === undefined) {
                    isValid = false;
                }
            });
        ...
        if (this.product.eyeLeft) {
            var addAux_2 = false;
            lodash__WEBPACK_IMPORTED_MODULE_13__["each"](this.product.parametersLeft, function (param) {
                if (param.name === 'Design') {
                    if (param.selected === 'Elipsys_STD_MF' ||
                        param.selected === 'Elipsys_KC_MF' || param.selected === 'Elipsys_SE_MF') {
                        addAux_2 = true;
            ...
            lodash__WEBPACK_IMPORTED_MODULE_13__["each"](this.product.setLeft, function (param) {
                if (param.selected === null || param.selected === undefined) {
                    isValid = false;
                }
            });
    ...
    ProductViewLenticonComponent.prototype.clean = function (eye) {
        ...
        // parameter
        lodash__WEBPACK_IMPORTED_MODULE_13__["each"](parameters, function (param) {
            param.selected = null;
            param.sel = null;
        });
        if (eye === 'right') {
    ...
    ProductViewLenticonComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_products_product_service__WEBPACK_IMPORTED_MODULE_1__["ProductService"],
            ...
            _shared_services_basket_basket_service__WEBPACK_IMPORTED_MODULE_4__["BasketService"],
            _shared_services_shippingAddress_shipping_address_service__WEBPACK_IMPORTED_MODULE_5__["ShippingAddressService"],
            _shared_services__WEBPACK_IMPORTED_MODULE_6__["UserService"],
...
var ProductViewMagicComponent = /** @class */ (function () {
    ...
    ProductViewMagicComponent.prototype.getProducts = function () {
        var _this = this;
        this.spinner.show();
        this.productService.findBySupplier$(5).subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_4__["CodeHttp"].ok) {
                _this.products = res.data;
                _this.getProductView();
                _this.spinner.hide();
...
module.exports = "<ngx-spinner bdColor=\"rgba(51, 51, 51, 0.8)\" size=\"medium\" color=\"#fff\" type=\"ball-beat\"></ngx-spinner>\n<div class=\"info-breadcrumbs\" *ngIf=\"product\">\n  <div class=\"header-body\">\n    <h4 class=\"page-header\">\n      {{ 'Product Details' | translate }}\n    </h4>\n    <ol class=\"breadcrumb\">\n      <li class=\"breadcrumb-item\">\n        <a class=\"link\" href=\"Javascript:void(0)\" [routerLink]=\"['/dashboard']\">\n          <i class=\"fa fa-dashboard\"></i> {{ 'Dashboard' | translate }}</a>\n      </li>\n      <li class=\"breadcrumb-item\">\n        <a class=\"link\" href=\"Javascript:void(0)\" [routerLink]=\"['/products']\">\n          <i class=\"fa fa-edit\"></i> {{ 'Products List' | translate }}</a>\n      </li>\n      <li class=\"breadcrumb-item active\">\n        <i class=\"fa fa-eye\"></i> {{ 'Product Details' | translate}}</li>\n    </ol>\n  </div>\n</div>\n<div class=\"padding-detail\" *ngIf=\"product\">\n  <div class=\"card\">\n    <div class=\"\">\n      <!-- row (name-price-image) -->\n      <div class=\"row wrapper\">\n        <div class=\"preview col-md-12\">\n          <!-- name-price -->\n          <div class=\"main-info\">\n            <h3 class=\"product-title\">{{'Order Form For' | translate }}:\n              <br>\n              <i>{{ product.name }}</i>\n            </h3>\n          </div>\n          <!-- image -->\n          <!-- <div class=\"preview-pic tab-content main-info\">\n            <div class=\"tab-pane active\" id=\"pic-1\">\n              <img src=\"{{ product.mainImg }}\" />\n            </div>\n          </div>-->\n        </div>\n      </div>\n\n      <!-- row (properties-material-replacement-warranty-sheet) -->\n      <div class=\"row product-info\" *ngIf=\"product.properties.values.length === 3\">\n        <div class=\"item-properties col-md-4\" *ngFor=\"let property of product.properties.values\">\n          <i class=\"{{ property.class }}\"></i>\n          <p>{{ property.text | translate }}</p>\n        </div>\n      </div>\n\n      <div class=\"row product-info\" *ngIf=\"product.properties.values.length === 4\">\n        <div class=\"item-properties col-md-6\" *ngFor=\"let property of product.properties.values\">\n          <i class=\"{{ property.class }}\"></i>\n          <p>{{ property.text | translate }}</p>\n        </div>\n      </div>\n\n      <!-- row (pacient, client, shipping address) -->\n      <div class=\"row product-info\">\n        <!-- client -->\n        <div class=\"col-lg-3\">\n          <dt class=\"title\">{{ 'Customer Full Name' | translate }}</dt>\n          <div class=\"row info-content\" [hidden]=\"user.role.idRole !== 3\">\n            <input class=\"form-control\" type=\"text\" placeholder=\"{{ 'Enter name customer' | translate }}\" required\n              [(ngModel)]=\"product.client\" disabled>\n          </div>\n          <div class=\"row info-content\" [hidden]=\"user.role.idRole === 3\">\n            <ng-select [items]=\"listCustomers\" (change)=\"onSelectedClient($event)\" [(ngModel)]=\"CustomersSelected\"\n              required [virtualScroll]=\"true\" bindLabel=\"name\" bindValue=\"idUser\" placeholder=\"{{ 'Select value' | translate }}\">\n            </ng-select>\n          </div>\n        </div>\n        <!--shipping address-->\n         <!--shipping address-->\n        <div class=\"col-lg-5\">\n          <span class=\"title\">{{ 'Shipping Address' | translate }}</span>\n          <div class=\"row info-content \">\n            <input class=\"form-control readonly-input\" type=\"text\" [(ngModel)]=\"product.shippingAddress\" placeholder=\"{{ 'This field is filled when the client is selected.' | translate }}\"\n              readonly>\n          </div>\n        </div>\n         <!--Price-->\n         <div class=\"col-lg-3\">\n          <h4 class=\"padding-price\" [hidden]=\"(priceFrom==='' && priceUp==='') || product.priceSale !==''\">\n            <span>{{ priceFrom | currency : \"USD $\"}}{{priceFrom ? ' - ':''}}{{ priceUp | currency : \"$\"}}</span>\n            <!--<span></span>-->\n          </h4>\n          <h4 class=\"padding-price\" [hidden]=\"product.priceSale===''\">\n            <span>{{ product.priceSale | currency : \"USD $\" }}</span>\n          </h4>\n        </div>\n      </div>\n\n      <div class=\"row product-info\">\n        <div class=\"col-md-12 title\">\n          <label> {{ 'Please specific your product' | translate }}</label>\n        </div>\n      </div>\n      <!--quantity right-->\n      <div class=\"col-lg-4\">\n        <div class=\"row\">\n          <div class=\"col-lg-12\">\n              <label class=\"form-check-label\">{{ 'Quantity' | translate }}</label>\n          </div>\n          <div class=\"col-lg-6\">\n            <input class=\"form-control\" type=\"number\" step=1 min=\"1\" [(ngModel)]=\"product.quantity\" oninput=\"validity.valid||(value='');\" (change)=\"setPriceBoxes(product.quantity)\">\n          </div>\n        </div>\n      </div>\n\n\n      <br>\n      <div class=\"row\">\n        <div class=\"col-md-12 buy-btns\">\n          <button [hidden]=\"user.role.idRole === 3\" class=\"btn btn-lg btn-primary btn-outline-primary text-uppercase margin-button\"\n            (click)=\"formIsValid() && addToCart(2)\" [disabled]=\"!formIsValid()\">\n            {{ 'Buy Now' | translate }}\n          </button>\n          <button class=\"btn btn-lg btn-outline-primary text-uppercase margin-button\" (click)=\"formIsValid() && addToCart(1)\"\n            [disabled]=\"!formIsValid()\">\n            <i class=\"fa fa-cart-plus\"></i> {{ 'Add to cart' | translate }}\n          </button>\n        </div>\n      </div>\n    </div>\n  </div>\n"
...
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ngx-spinner */ "./node_modules/ngx-spinner/ngx-spinner.umd.js");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(ngx_spinner__WEBPACK_IMPORTED_MODULE_17__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductViewComponent = /** @class */ (function () {
    ...
    ProductViewComponent.prototype.getProducts = function () {
        var _this = this;
        this.spinner.show();
        this.productService.findBySupplier$(1).subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_4__["CodeHttp"].ok) {
                _this.products = res.data;
                _this.getProductView();
                _this.spinner.hide();
...
var ProductsListInternalComponent = /** @class */ (function () {
    ...
    ProductsListInternalComponent.prototype.getProducts = function () {
        var _this = this;
        this.spinner.show();
        this.productService.findBySupplier$(this.idSupplier).subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_2__["CodeHttp"].ok) {
                _this.products = res.data;
                _this.setPrice();
    ...
    ProductsListInternalComponent.prototype.redirectFather = function (product) {
        this.products = this.productsAux;
        this.products = this.products.filter(function (item) {
    ...
    ProductsListInternalComponent.prototype.backToFathers = function () {
        this.currentFather = '';
        this.showFathersMarkennovy = true;
    };
        ...
        if (this.user.role.idRole === 1) {
            ...
            switch (idSupplier) {
                ...
                case 7://fluo strips y saline spectrum
                    ...
                    break;
                case 5://magic look
                    this.productService.findBySupplier$(idSupplier).subscribe(function (res) {
                        if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_1__["CodeHttp"].ok) {
                            _this.products = res.data;
