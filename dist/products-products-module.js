        ...
        lodash__WEBPACK_IMPORTED_MODULE_16__["each"](this.listBasket, function (productRequested) {
            ...
            if (productRequested.name !== 'Inserts (DMV)'
                ...
                lodash__WEBPACK_IMPORTED_MODULE_16__["each"](details, function (detail) {
                    ...
                    lodash__WEBPACK_IMPORTED_MODULE_16__["each"](detail.parameters, function (parameter) {
...
var ProductViewEuropaComponent = /** @class */ (function () {
    ...
    ProductViewEuropaComponent.prototype.buildProductsSelected = function () {
        ...
        var signPowerRightTrial = this.signPowerRightTrial;
        var signPowerLeftTrial = this.signPowerLeftTrial;
        var typeCurveLeft = this.typeCurveLeft;
        var typeCurveRight = this.typeCurveRight;
        var typeCurveLeftTrial = this.typeCurveLeftTrial;
        var typeCurveRightTrial = this.typeCurveRightTrial;
        ...
        lodash__WEBPACK_IMPORTED_MODULE_1__["each"](productsSelected, function (productSelected, index) {
            ...
            if (productSelected.eye === 'Right') {
                ...
                productSelected.observations = product.observationsRight;
                //set
                lodash__WEBPACK_IMPORTED_MODULE_1__["each"](product.setRight, function (parameter, index) {
                    product.setRight[index] = lodash__WEBPACK_IMPORTED_MODULE_1__["omit"](parameter, ['type', 'values', 'sel']);
            ...
            if (productSelected.eye === 'Left') {
                ...
                productSelected.observations = product.observationsLeft;
                //set
                lodash__WEBPACK_IMPORTED_MODULE_1__["each"](product.setLeft, function (parameter, index) {
                    product.setLeft[index] = lodash__WEBPACK_IMPORTED_MODULE_1__["omit"](parameter, ['type', 'values', 'sel']);
                    if (parameter.name === 'Base Curve') {
    ...
    ProductViewEuropaComponent.prototype.valueDiameter = function (value, eye) {
        if (value === '17.0' ||
            ...
            // assing product code
            var prCode = this.setCodeProductByDiameter(this.productName, '(Dia. 15.2-16.5)');
            if (eye === 'right') {
                this.checkAdditional('right');
    ...
    ProductViewEuropaComponent.prototype.clean = function (eye) {
        ...
        // set
        lodash__WEBPACK_IMPORTED_MODULE_1__["each"](set, function (item) {
            item.selected = null;
            item.sel = null;
        });
        // header
    ...
    ProductViewEuropaComponent.prototype.disabledOption = function (item) {
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], ProductViewEuropaComponent.prototype, "notchRight", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('notchLeft'),
        __metadata("design:type", Object)
    ], ProductViewEuropaComponent.prototype, "notchLeft", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('selectedFilesLeftEye'),
        __metadata("design:type", Object)
    ...
    ProductsListsComponent.prototype.getSuppliers = function () {
        ...
        this.supplierService.findAll$().subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_1__["CodeHttp"].ok) {
                ...
                if (_this.user.role.idRole === 3) {
                    if (_this.user.userResponse.membership.idMembership !== 2) {
                        _this.listSupplier = lodash__WEBPACK_IMPORTED_MODULE_3__["remove"](_this.listSupplier, function (supplier) {
