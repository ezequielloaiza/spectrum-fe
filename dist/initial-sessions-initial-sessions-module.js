...
var ProtocolsComponent = /** @class */ (function () {
    function ProtocolsComponent(formBuilder, countryService, supplierService, userStorageService, translate, notification, router, protocolClientService, protocolProformaService, spinner) {
        ...
        this.protocolsShippingSave = new Array;
        this.protocolsShippingCopy = new Array;
...
var ProtocolsproformaComponent = /** @class */ (function () {
    function ProtocolsproformaComponent(formBuilder, countryService, supplierService, userStorageService, translate, notification, router, protocolProformaService) {
        this.formBuilder = formBuilder;
        this.countryService = countryService;
        this.supplierService = supplierService;
        this.userStorageService = userStorageService;
...
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var _shared_services_protocolClient_protocol_client_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../shared/services/protocolClient/protocol-client.service */ "./src/app/shared/services/protocolClient/protocol-client.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var ProtocolsshippingComponent = /** @class */ (function () {
    function ProtocolsshippingComponent(formBuilder, countryService, supplierService, userStorageService, translate, notification, router, protocolClientService, spinner) {
        this.formBuilder = formBuilder;
        this.countryService = countryService;
        this.supplierService = supplierService;
        this.userStorageService = userStorageService;
    ...
    ProtocolsshippingComponent.prototype.initializeForm = function () {
        this.form = this.formBuilder.group({
            accNumber: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]]
        });
    };
    ProtocolsshippingComponent.prototype.loadFields = function () {
        if (this.protocolsCopy.length === 0) {
            this.protocols = [
    ...
    ProtocolsshippingComponent.prototype.loadSuppliers = function () {
        ...
        this.supplierService.findAll$().subscribe(function (res) {
            if (res.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_10__["CodeHttp"].ok) {
                _this.suppliers = lodash__WEBPACK_IMPORTED_MODULE_11__["orderBy"](res.data, ['companyName']);
                _this.getProtocols();
            }
            else {
                console.log(res.errors[0].detail);
    ...
    ProtocolsshippingComponent.prototype.selectSupplier = function (idSupplier, protocol, value) {
        var index = lodash__WEBPACK_IMPORTED_MODULE_11__["indexOf"](value.suppliers, idSupplier);
        if (index > -1) {
            value.suppliers.splice(index, 1);
            protocol.selectedSuppliers.splice(lodash__WEBPACK_IMPORTED_MODULE_11__["indexOf"](protocol.selectedSuppliers, idSupplier), 1);
        }
        else if (this.allowedSelection(idSupplier, protocol)) {
            value.suppliers.push(idSupplier);
            protocol.selectedSuppliers.push(idSupplier);
    ...
    ProtocolsshippingComponent.prototype.allowedSelection = function (idSupplier, protocol) {
        return lodash__WEBPACK_IMPORTED_MODULE_11__["indexOf"](protocol.selectedSuppliers, idSupplier) === -1;
    };
    ProtocolsshippingComponent.prototype.supplierSelected = function (idSupplier, protocolValue) {
        return lodash__WEBPACK_IMPORTED_MODULE_11__["indexOf"](protocolValue.suppliers, idSupplier) > -1;
    };
    ProtocolsshippingComponent.prototype.addValue = function (protocol) {
        protocol.values.push({ content: '', suppliers: [] });
    };
    ProtocolsshippingComponent.prototype.hiddenSupplier = function (protocol, supplier) {
        return !!lodash__WEBPACK_IMPORTED_MODULE_11__["includes"](protocol.selectedSuppliers, supplier.idSupplier);
    };
    ProtocolsshippingComponent.prototype.removeValue = function (protocol, index) {
        protocol.selectedSuppliers = lodash__WEBPACK_IMPORTED_MODULE_11__["difference"](protocol.selectedSuppliers, protocol.values[index].suppliers);
        protocol.values.splice(index, 1);
    };
    ProtocolsshippingComponent.prototype.getCountry = function () {
        var _this = this;
        this.countryService.findAll$().subscribe(function (res) {
    ...
    ProtocolsshippingComponent.prototype.save = function () {
        this.buildProtocols();
        var listProtocolsShipping = this.protocolsSave;
        var serviceShipping = this.protocolClientService;
        var recordsShipping = this.validRecordsShipping;
        var self = this;
        var userId = this.currentUser.idUser;
        if (listProtocolsShipping.length > 0) {
            this.spinner.show();
            serviceShipping.remove$(userId).subscribe(function (resRem) {
                if (resRem.code === _shared_enum_code_http_enum__WEBPACK_IMPORTED_MODULE_10__["CodeHttp"].ok) {
                    lodash__WEBPACK_IMPORTED_MODULE_11__["each"](listProtocolsShipping, function (protocolShipping) {
                        serviceShipping.update$(protocolShipping).subscribe(function (res) {
                            recordsShipping++;
    ...
    ProtocolsshippingComponent.prototype.showMessage = function (records) {
        var _this = this;
    ...
    ProtocolsshippingComponent.prototype.buildProtocols = function () {
        ...
        var userId = this.currentUser.idUser;
        //Protocolos seleccionados
        lodash__WEBPACK_IMPORTED_MODULE_11__["each"](protocolsSuppliers, function (item) {
            var protocolAux = new _shared_models_protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"]();
            lodash__WEBPACK_IMPORTED_MODULE_11__["each"](protocols, function (protocol, index) {
                // Values
                lodash__WEBPACK_IMPORTED_MODULE_11__["each"](protocol.values, function (itemValue) {
                    // Suppliers
                    lodash__WEBPACK_IMPORTED_MODULE_11__["each"](itemValue.suppliers, function (supplier) {
                        if (item.supplierId === supplier) {
    ...
    ProtocolsshippingComponent.prototype.getProtocols = function () {
        var protocolsSave = [];
        lodash__WEBPACK_IMPORTED_MODULE_11__["each"](this.suppliers, function (supplier) {
            var protocol = new _shared_models_protocol__WEBPACK_IMPORTED_MODULE_1__["Protocol"]();
            protocol.supplierId = supplier.idSupplier;
            protocol.valid = false;
            protocolsSave.push(protocol);
    ...
    ProtocolsshippingComponent.prototype.getNamesTypeList = function (value) {
        var self = this;
        var suppliersName = [];
        lodash__WEBPACK_IMPORTED_MODULE_11__["each"](self.suppliers, function (supplier) {
            if (lodash__WEBPACK_IMPORTED_MODULE_11__["includes"](value.suppliers, supplier.idSupplier)) {
                suppliersName.push(supplier.companyName);
            }
        });
        return suppliersName.join(', ');
    };
    ProtocolsshippingComponent.prototype.disabledSupplier = function (protocol, value, supplier) {
        return !!lodash__WEBPACK_IMPORTED_MODULE_11__["includes"](protocol.selectedSuppliers, supplier.idSupplier) && !lodash__WEBPACK_IMPORTED_MODULE_11__["includes"](value.suppliers, supplier.idSupplier);
    };
    ProtocolsshippingComponent.prototype.checkedSupplier = function (protocol, value, supplier) {
        return !!lodash__WEBPACK_IMPORTED_MODULE_11__["includes"](protocol.selectedSuppliers, supplier.idSupplier);
    };
    ...
    ProtocolsshippingComponent.prototype.validContent = function (protocol, pos) {
        var valid = true;
        if (protocol.values[pos].content === '') {
            valid = false;
        }
    ...
    ProtocolsshippingComponent.prototype.checkSuppliers = function (protocol, pos) {
        var show = true;
        if (protocol.values[pos].suppliers.length > 0) {
            show = false;
        }
    ...
    ProtocolsshippingComponent.prototype.checkedAllSuppliers = function (protocol) {
        return this.suppliers.length === protocol.selectedSuppliers.length;
    };
    ProtocolsshippingComponent.prototype.onSelectionAll = function (protocol, value) {
        var self = this;
        if (this.checkedAllSuppliers(protocol)) {
            protocol.selectedSuppliers = lodash__WEBPACK_IMPORTED_MODULE_11__["difference"](protocol.selectedSuppliers, value.suppliers);
            value.suppliers = [];
        }
        else {
            lodash__WEBPACK_IMPORTED_MODULE_11__["each"](self.suppliers, function (supplier) {
    ...
    ProtocolsshippingComponent.prototype.hideAdd = function (protocol) {
        return this.suppliers.length === protocol.selectedSuppliers.length ||
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], ProtocolsshippingComponent.prototype, "lista", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ...
    ProtocolsshippingComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            ...
            ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"],
            _shared_services_protocolClient_protocol_client_service__WEBPACK_IMPORTED_MODULE_8__["ProtocolClientService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_12__["NgxSpinnerService"]])
